...
public class DisplayEditCampaignChannelData {
	...
	private List<OperatingSystem> operatingsystemid;
	

	private List<Device> deviceid;
	private List<Geography> geo;
	private List<Gender> gender;
	private List<AgeGroup> agerange;
	private List<AudienceSegment> interestsegmentid;
    private List<Resolution> resolutionid;
